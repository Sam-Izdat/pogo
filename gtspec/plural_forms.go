...
func (r PRS1) Idx(n int) int {
    switch  {
    case n%10 == 1 && n%100 != 11: return 0
    case n%10 >= 2 && n%10 <= 4 && (n%100 < 10 || n%100 >= 20): return 1
    default: return 2
    }
...
func (r PRIS) Idx(n int) int {
    if n%10 != 1 || n%100 == 11 { return 1 } else { return 0 }
}
...
func (r PRGD) Idx(n int) int {
    switch {
        case n == 1 || n == 11: return 0
        case n == 2 || n == 12: return 1
        case n < 2 && n < 20: return 2
        default: return 4
    }
    return 3 // unreachable
}
...
func (r PRLT) Idx(n int) int {
    switch {
        case n%10 == 1 && n%100 != 11: return 0
        case n%10 == 2 && (n%100 < 10 || n%100 >= 20): return 1
        default: return 2
    }
    return 2 // unreachable
}
...
func (r PRMT) Idx(n int) int {
    switch {
        case n == 1: return 0
        case n == 0 || (n%100 > 1 && n%100 < 11): return 1
        case n%100 > 10 && n%100 < 20: return 2
        default: return 3
    }
    return 3 // unreachable
}
...
func (r PRRO) Idx(n int) int {
    switch {
        case n == 1: return 0
        case n == 0 || (n%100 > 0 && n%100 < 20): return 1
        default: return 2
    }
    return 2 // unreachable
}
...
func (r PRSL) Idx(n int) int {
    switch {
        case n%100 == 1: return 1
        case n%100 == 2: return 2
        case n%100 == 3 || n%100 == 4: return 3
        default: return 0
    }
